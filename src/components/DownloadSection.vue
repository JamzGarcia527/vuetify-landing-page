        ...
        <v-col cols="10">
          <v-row align="center" justify="center">
            <v-col sm="4" class="hidden-xs-only">
              <v-img src="@/assets/img/satellite-dish-23300_960_720.png" class="d-block ml-auto mr-auto" max-width="350px" />
            </v-col>
...
<style scoped>
#download {
  background-image: url("~@/assets/img/antennas-3414640_960_720.jpg");
